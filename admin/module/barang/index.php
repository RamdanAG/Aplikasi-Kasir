        ...
        <button type="button" style="background: #0057e7; color:white;" class="btn btn-md mr-2" data-toggle="modal" data-target="#myModal">
            <i class="fa fa-plus" style="color: white;"></i> Tambah Barang</button>
        <a href="index.php?page=barang&stok=yes" style="background: #008744; color:white;" class="btn btn-md mr-2">
            <i class="fa fa-list"></i> Sortir Stok Kurang</a>
        <a href="index.php?page=barang" style="background: #ffa700; color:white;" class="btn btn-md">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php } else { ?>
                                        <a href="index.php?page=barang/details&barang=<?php echo $isi['id_barang']; ?>"><button class="btn btn-xs" style="background:#008744; color:white;">Details</button></a>

                                        <a href="index.php?page=barang/edit&barang=<?php echo $isi['id_barang']; ?>"><button class="btn btn-xs" style="background:#ffa700; color:white;">Edit</button></a>
                                        <a href="fungsi/hapus/hapus.php?barang=hapus&id=<?php echo $isi['id_barang']; ?>" onclick="javascript:return confirm('Hapus Data barang ?');"><button class="btn btn-xs" style="background:#d62d20; color:white;">Hapus</button></a>
                                    <?php } ?>
                            </tr>
                        <?php
                            $no++;
