 ...
 <?php
	...
	?>
 <h4>Keranjang Penjualan/Transaksi</h4>
 <br>
 ...
 <div class="row">
 	<div class="col-sm-4">
 		<div class="card card-primary mb-3">
 			<div class="card-header" style="background:#242424; color:white;">
 		...
 		<div class="card card-primary">
 			<div class="card-header" style="background:#242424; color:white;">
 				<h5><i class="fa fa-shopping-cart"></i> KASIR
 					<a style="background:#d62d20; color:white;" class="btn float-right" onclick="javascript:return confirm('Apakah anda ingin reset keranjang ?');" href="fungsi/hapus/hapus.php?penjualan=jual">
 						...
 						<tbody>
 							...
 							<?php foreach ($hasil_penjualan  as $isi) { ?>
 								<tr>
 									...
 									<td>
 										<button type="submit" class="btn" style="background: linear-gradient(151deg, rgba(2,0,36,1) 0%, rgba(254,255,0,1) 0%, rgba(255,166,0,1) 100%); color:white;">Update</button>
 										</form>
 										<!-- aksi ke table penjualan -->
 										<a href="fungsi/hapus/hapus.php?jual=jual&id=<?php echo $isi['id_penjualan']; ?>&brg=<?php echo $isi['id_barang']; ?>
											&jml=<?php echo $isi['jumlah']; ?>" style="background: rgb(2,0,36);
background: linear-gradient(151deg, rgba(2,0,36,1) 0%, rgba(255,0,0,1) 0%, rgba(255,81,0,1) 100%); color:white;" class="btn"><i class="fa fa-times"></i>
 										</a>
 									</td>
 								</tr>
 							<?php $no++;
 						...
 						<table class="table table-stripped">
 							...
 							<form method="POST" action="index.php?page=jual&nota=yes#kasirnya">
 								...
 								<tr>
 									...
 									<td><button class="btn" style="background:#008744; color:white"><i class="fa fa-shopping-cart"></i> Bayar</button>
 							...
 							<tr>
 								...
 								<td>
									...
									&bayar=<?php echo $bayar; ?>&kembali=<?php echo $hitung; ?>" target="_blank">
 										<button class="btn" style="color:white; background:#ffa700;">
